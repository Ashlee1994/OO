...
public class UserServlet extends BaseServlet {
	 ...
	 * @throws IOException
	 */
	public String registStore(HttpServletRequest req, HttpServletResponse resp)
			throws ServletException, IOException {
		 ...
		 * 3. 使用service完成业务
		 */
		userService.registStore(owner.getUid());
		/*
		 * 4. 保存成功信息，转发到msg.jsp显示！
		 */
		
		req.getSession().setAttribute("userKind", 1);
		req.setAttribute("code", "success");
		req.setAttribute("msg", "注册店铺成功！");
		return "f:/jsps/registRefresh.jsp";
	}
	//刷新积分
	public String refreshCredit(HttpServletRequest req, HttpServletResponse resp)
			throws ServletException, IOException {
		 ...
		 * 3. 使用service完成业务
		 */
		int credit = userService.refreshCredit(owner.getUid());
		/*
		 * 4. 保存成功信息，转发到msg.jsp显示！
		 */
	...
	public String login(HttpServletRequest req, HttpServletResponse resp)
		...
		if(user == null) {
			...
			if(!user.isStatus()) {
				...
				req.getSession().setAttribute("userKind", user.getKind());
				req.getSession().setAttribute("userKind", user.getCredit());
