package cn.itcast.goods.seller.book.web.servlet;
...
public class SellerBookServlet extends BaseServlet {
	 ...
	 * @throws IOException
	 */
	public String sellerDelete(HttpServletRequest req, HttpServletResponse resp)
			throws ServletException, IOException {
		String bid = req.getParameter("bid");
		
		bookService.sellerDelete(bid);//删除数据库的记录
	...
	public String edit(HttpServletRequest req, HttpServletResponse resp)
		...
		book.setSeller(owner);//设置图书所有者
		
		bookService.edit(book);
		req.setAttribute("msg", "修改图书成功！");
		req.setAttribute("book", book);
		return "f:/jsps/book/sellerEdit.jsp";
	}
	...
	public String load(HttpServletRequest req, HttpServletResponse resp)
		 ...
		 * 4. 转发到desc.jsp显示
		 */
		return "f:/jsps/book/SellerDesc.jsp";
	}
